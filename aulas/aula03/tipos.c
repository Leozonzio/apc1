...
int main() {
  ...
  printf("o tamanho do void na memória é %lu byte(s)\n.", sizeof(void));
  ...
  printf("o tamanho do long double na memória é %lu byte(s)\n.", sizeof(long double));
  ...
  printf("a faixa de valores do unsigned short int vai de %i até %i\n", 0, USHRT_MAX);
  printf("a faixa de valores do unsigned int vai de %i até %u\n", 0, UINT_MAX);
  printf("a faixa de valores do unsigned long int vai de %i até %lu\n", 0, ULONG_MAX);
